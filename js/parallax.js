function mr_parallax() {
  ...
  function b() {
    (E = void 0 == window.mr_variant ? !1 : !0),
      E &&
        ((C = $(".viu").get(0)),
        void 0 != C &&
          (C.scrollBy = function (a, b) {
            this.scrollTop += b;
          })),
      void 0 != C &&
        (C.addEventListener("scroll", h, !1),
        window.addWheelListener(C, i, !1),
  ...
  function c() {
    var a = 0;
    return (a = E
      ? $(".viu").find("nav:first").outerHeight(!0)
      : $(document).find("nav:first").outerHeight(!0));
  }
  function d(a, b, c, d) {
    var e = a - 1;
    return (
  ...
  function e() {
    ...
    q &&
      ((w += -t * d(s, 0, z, B)),
      (w > A || -A > w) && (C.scrollBy(0, w), (w = 0)),
      s++,
      s > B &&
        ((s = 0), (q = !1), (r = !0), (t = 0), (u = 0), (v = 0), (w = 0))),
      k(e);
  }
  function f(a, b) {
    if (E) {
  ...
  $(document).ready(function () {
    ...
    (n = Math.max(
      ...
      /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(
        ...
        : k && (window.mr_parallax.profileParallaxElements(), b());
  }),
